...
public: \
	...
	: tester_case(#tc_name) \
	{ \
		register_func(static_cast<sensorctl::tester_case::test_func>(&sensorctl::tester_case::test_case##tc_name::test)); \
	} \
	void test(void); \
} test_case_##tc_name_##instance; \
void test_case_##tc_name::test(void)
...
class tester_option {
public:
	static void show_full_log(bool show) { m_full_log = show; }
	static bool full_log(void) { return m_full_log; }
