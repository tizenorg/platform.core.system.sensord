...
public:
	...
	bool add_register_event_info(int handle, unsigned int event_type,
	...
	bool set_event_batch_info(int handle, unsigned int event_type, unsigned int interval, unsigned int latency);
