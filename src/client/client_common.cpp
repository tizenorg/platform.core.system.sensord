...
log_element g_log_elements[] = {
	...
	FILL_LOG_ELEMENT(LOG_ID_SENSOR_TYPE, GESTURE_MOVEMENT_SENSOR, 0, 1),
	...
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GESTURE_MOVEMENT_CHANGE_STATE_EVENT, 0, 1),
};
...
bool is_single_state_event(unsigned int event_type)
{
	...
	case GESTURE_MOVEMENT_CHANGE_STATE_EVENT:
		return true;
		break;
	}
