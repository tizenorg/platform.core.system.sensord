...
typedef enum {
	...
	SENSOR_DEVICE_HUMAN_SLEEP_DETECTOR_SENSOR,
	SENSOR_DEVICE_HUMAN_EXERCISE_MONITOR_SENSOR,
	SENSOR_DEVICE_HUMAN_STRESS_MONITOR_SENSOR,
	SENSOR_DEVICE_HUMAN_STAIR_TRACKER_SENSOR,
