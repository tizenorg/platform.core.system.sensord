...
bool orientation_sensor::on_start(void)
{
	...
	m_accel_sensor->add_interval((long)this, (m_interval/MS_TO_US), true);
	m_accel_sensor->start();
	m_gyro_sensor->add_client(GYROSCOPE_EVENT_RAW_DATA_REPORT_ON_TIME);
	m_gyro_sensor->add_interval((long)this, (m_interval/MS_TO_US), true);
	m_gyro_sensor->start();
	m_magnetic_sensor->add_client(GEOMAGNETIC_EVENT_RAW_DATA_REPORT_ON_TIME);
	m_magnetic_sensor->add_interval((long)this, (m_interval/MS_TO_US), true);
