...
bool csensor_client_info::change_event_interval_info(int handle, unsigned int event_type,
...
bool csensor_client_info::set_event_interval_info(int handle, unsigned int event_type, unsigned int interval)
{
	AUTOLOCK(m_handle_info_lock);
...
bool csensor_client_info::get_event_info(int handle, unsigned int event_type, unsigned int &interval, int &cb_type, void* &cb, void* &user_data)
{
	AUTOLOCK(m_handle_info_lock);
...
unsigned int csensor_client_info::get_active_min_interval(sensor_id_t sensor)
{
