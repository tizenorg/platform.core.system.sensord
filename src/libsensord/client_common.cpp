...
log_element g_log_elements[] = {
	...
	FILL_LOG_ELEMENT(LOG_ID_DATA, PROXIMITY_CHANGE_STATE_EVENT, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, PROXIMITY_STATE_EVENT, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, PRESSURE_RAW_DATA_EVENT, 0, 25),
