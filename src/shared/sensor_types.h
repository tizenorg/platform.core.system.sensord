...
#define SENSOR_TYPE(DEF_SENSOR, DEF_SENSOR_VALUE, DEF_SENSOR_DEPRECATED) \
	...
	DEF_SENSOR_DEPRECATED(BIO_HRM_SENSOR, HRM_SENSOR) \
	DEF_SENSOR(HRM_LED_GREEN_SENSOR) \
	DEF_SENSOR_DEPRECATED(BIO_LED_GREEN_SENSOR, HRM_LED_GREEN_SENSOR) \
	DEF_SENSOR(HRM_LED_IR_SENSOR) \
	DEF_SENSOR_DEPRECATED(BIO_LED_IR_SENSOR, HRM_LED_IR_SENSOR) \
	DEF_SENSOR(HRM_LED_RED_SENSOR) \
	DEF_SENSOR_DEPRECATED(BIO_LED_RED_SENSOR, HRM_LED_RED_SENSOR) \
	...
	DEF_SENSOR_DEPRECATED(BIO_SENSOR, HRM_RAW_SENSOR) \
