...
public:
	...
	virtual bool add_interval(long int client_id, unsigned int interval, bool is_processor = false);
	virtual bool delete_interval(long int client_id, bool is_processor = false);
