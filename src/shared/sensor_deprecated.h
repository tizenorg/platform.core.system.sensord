...
#define ACCELEROMETER_SIMPGRAV_DATA_SET (ACCELEROMETER_SENSOR << 16) | 0x0008

#define ACCELEROMETER_EVENT_GRAVITY_DATA_REPORT_ON_TIME (ACCELEROMETER_SENSOR << 16) | 0x0080
#define ACCELEROMETER_EVENT_SIMPGRAV_DATA_REPORT_ON_TIME (ACCELEROMETER_SENSOR << 16) | 0x0080
...
#define SIMPGRAV_BASE_DATA_SET SIMPGRAV_RAW_DATA_EVENT
#define SIMPGRAV_EVENT_RAW_DATA_REPORT_ON_TIME SIMPGRAV_RAW_DATA_EVENT
