...
bool linear_accel_sensor::on_start(void)
{
	...
	m_gravity_sensor->add_interval((long)this, (m_interval/MS_TO_US), true);
...
bool linear_accel_sensor::on_stop(void)
{
	...
	m_gravity_sensor->delete_interval((long)this, true);
...
bool linear_accel_sensor::add_interval(int client_id, unsigned int interval)
{
	...
	m_accel_sensor->add_interval((long)this , interval, true);
