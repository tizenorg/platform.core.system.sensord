...
struct sensors_module_t {
	...
	int (*get_info_list)(struct sensors_device_t *dev, int handle,
			sensor_info_t **infos);
	...
	int (*get_sensor_data)(struct sensors_device_t *dev, int handle, sensors_data_t *data);

	int (*batch)(struct sensors_device_t *dev, int handle, int flags, unsigned long long interval_ns, unsigned long long max_report_latency_ns);
