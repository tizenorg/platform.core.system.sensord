...
int main(int argc, char **argv)
{
	...
	result = check_sensor_api(PROXIMITY_EVENT_CHANGE_STATE, interval);
	fprintf(fp, "Proxi - EVENT_CHANGE_STATE - %d\n", result);

	result = check_sensor_api(PROXIMITY_EVENT_STATE_REPORT_ON_TIME, interval);
	fprintf(fp, "Proxi - EVENT_STATE_REPORT_ON_TIME - %d\n", result);

	result = check_sensor_api(PROXIMITY_EVENT_DISTANCE_DATA_REPORT_ON_TIME, interval);
